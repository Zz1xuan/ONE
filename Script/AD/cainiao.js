...
else if (-1 !== $request.url.indexOf("mtop.cainiao.guoguo.nbnetflow.ads.mshow")) {
  if (ddgksf2013.data["1308"]) {
    delete ddgksf2013.data["1308"];
  }
  if (ddgksf2013.data["1275"]) {
    delete ddgksf2013.data["1275"];
  }
}
