if (-1 != $request.url.indexOf("people/my")) {
    ...
    if (n.data.sections.length > 0 && "quickEntranceV3" != n.data.sections[0].content_style) {
        var a = {
            sectionStyle: null,
    ...
    i.data.detailSections = Object.values(i.data.detailSections).filter(e => "recommendation" != e.sectionType), $done({
